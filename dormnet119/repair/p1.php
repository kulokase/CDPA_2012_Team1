...
<body>
	<center><h1><strong><em>Dormnet119</em></strong></h1>
	<style type="text/css">
		.y0-uix-button {
   			 height:2.0833em;
	...
	<style type="text/css">
		...
		.button_word
		{
 		 /* content: 3px;*/
			...
			font-size:1.7cm;
			font-weight:1000;
			font-family:"標楷體","DFKai-sb","新細明體","PMingLiU";
			color:hsla(30,80%,50%,0.5);
			filter:shadow;
			filter:glow;
		}
	</style>
	<BUTTON  onclick="self.location.href='p2.php'">
         <span class="yt-uix-button">填 報 修 單</span>
	</BUTTON>
	<BUTTON onclick="self.location.href='p4.php'">
		<span class="yt-uix-button">改 報 修 單</span>
	</BUTTON>
